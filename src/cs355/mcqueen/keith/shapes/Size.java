...
/**
 * The {@code Size} class is used to describe the dimensions of some object in an n-dimensional space.  The number of
 * dimensions for the object depends on the number of coordinates provided to the constructor at the time of
 * instantiation.
 * <p>
 * To retrieve the lengths, call the {@link #getLength(int)} method, passing the index of the dimension.  The dimension
 * indices are 0-based.
 * <p>
