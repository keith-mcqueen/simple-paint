...
public class GUIFunctions {
	/**
	 * Refreshes the view by repainting the canvas. Call this any time the picture in the main view should change.
	 */
	...
	/**
	 * Changes the amount the vertical scroll bar returns when it is all the way at the bottom. Important: See
	 * setVScrollBarKnob for further clarification!
	 *
	...
	/**
	 * Changes the amount the horizontal scroll bar returns when it is all the way at the left. Important: See
	 * setHScrollBarKnob for further clarification!
	 *
	...
	/**
	 * Sets the width of the scroll bar's knob. This is not just purely visual! If you have, for example, a knob width of
	 * 2 and a maximum value of 4, then the knob will "fill" the last half of the scroll bar and return a value of 2 if
	...
	/**
	 * Sets the position of the scroll bar's knob. I do not believe this will trigger a scrollbar changed event in your
